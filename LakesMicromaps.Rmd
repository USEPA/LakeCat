...
nlcd$PctFor = nlcd$PctDecid2006Ws + nlcd$PctMxFst2006Ws + nlcd$PctMxFst2006Ws
...
# lakedata$PctUrb = log(lakedata$PctUrb)
# lakedata$PctAg[lakedata$PctAg > 0] = log(lakedata$PctAg[lakedata$PctAg > 0])
# lakedata$PctFor[lakedata$PctFor > 0] = log(lakedata$PctFor[lakedata$PctFor > 0])
...
lakes.dfm   <- melt(lakedata,  
                      #outcome variables  
                      measure.vars = c("PctUrb","PctAg","PctFor"),  
                      # classification variables  
                      id.vars = c("WSA_NAME"),  na.rm=TRUE)


lakes.dfc <- cast(lakes.dfm, WSA_NAME ~ variable, statsq)
names(lakes.dfc) <- c("WSA_NAME","PctUrb_N","PctUrb_Min","PctUrb_Q125","PctUrb_Median50","PctUrb_Q375","PctUrb_Max",
                      "PctAg_N","PctAg_Min","PctAg_Q125","PctAg_Median50","PctAg_Q375","PctAg_Max",
                      "PctFor_N","PctFor_Min","PctFor_Q125","PctFor_Median50","PctFor_Q375","PctFor_Max") 
lakes.dfc$WSA_NAME <- as.character(lakes.dfc$WSA_NAME)
...
mmplot(stat.data=lakes.dfc, 
       ...
       panel.data=list(NA,
                       "WSA_NAME",
                       list("PctUrb_Min","PctUrb_Q125","PctUrb_Median50","PctUrb_Q375","PctUrb_Max"),
                       list("PctAg_Min","PctAg_Q125","PctAg_Median50","PctAg_Q375","PctAg_Max"),
                       list("PctFor_Min","PctFor_Q125","PctFor_Median50","PctFor_Q375","PctFor_Max")),
       ord.by="PctUrb_Median50", 
       grouping=3, 
       median.row=F, 
       map.link=c("WSA_NAME", 'ID'), 
       panel.att=list(list(1, header='Light Gray Means\n Highlighted Above'), 
